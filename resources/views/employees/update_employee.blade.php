<x-layouts>
    <form action="{{ route('employee.update', $employee) }}" method="POST" class="p-6 max-w-lg mx-auto bg-gray-800 rounded-lg shadow-lg" enctype="multipart/form-data">
        @csrf
        @method('PUT')

        <!-- Form Title -->
        <h1 class="text-2xl text-gray-300 font-bold mb-6">Update Employee</h1>
